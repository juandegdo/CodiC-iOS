                        ...
                        if let fbUser = value.dictionaryValue, let fullName = fbUser["name"] as? String, let email = fbUser["email"] as? String, let id = fbUser["id"] as? String {
                            ...
                            UserService.Instance.login(_user, completion: {
                                ...
                                if success {
                                    ...
                                    if !message.isEmpty {
                                        AlertUtil.showOKAlert(self, message: "We can't find a Radioish account associated with that Facebook user.")
                                    }
                            ...
                            if (email != nil) {
                                ...
                                UserService.Instance.login(_user, completion: {
                                    ...
                                    if success {
                                        ...
                                        if !message.isEmpty {
                                            AlertUtil.showOKAlert(self, message: "We can't find a Radioish account associated with that Twitter user.")
                                        }
