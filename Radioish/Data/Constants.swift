...
class Constants {
    ...
    static let SegueRadioishWelcome = "segueToWelcome"
    static let SegueRadioishSignup = "Signup"
    static let SegueRadioishWelcomeProfile = "segueToWelcomeProfile"
    static let SegueRadioshWelcomeFinal = "WelcomeFinal"
    static let SegueRadioishHome = "GoHome"
    static let SegueRadioishSignIn = "GoSignIn"
    static let SegueRadioishShareBroadcastPopup = "ShareBroadcastPopUp"
    static let SegueRadioishRecordingBroadcast = "RecordingBroadcast"
    static let SegueRadioishEditBroadcast = "EditRecordingBroadcast"
    static let SegueRadioishStopBroadcast = "StopRecordingBroadcast"
    static let SegueRadioishSaveBroadcast = "SaveBroadcast"
    static let SegueRadioishShareBroadcast = "ShareBroadcast"
